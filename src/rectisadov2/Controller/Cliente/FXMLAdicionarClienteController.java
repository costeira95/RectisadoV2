 ...
 * @author Costeira
 */
public class FXMLAdicionarClienteController extends Stage {
    ...
    public FXMLAdicionarClienteController(AppStart appStart, TableView tblView, Stage stage) {
    ...
    void handleAdicionar(MouseEvent event) {
        try {
            int contribuinte = (txtContribuinte.getText().isEmpty()) ? 0 :
              ...
              Gestor.getInstance().addCliente(new Cliente(new ObjectId().toString(),
              ...
              new FXMLDialogSucessoController(appStart, this, "Cliente adicionado com sucesso!");
